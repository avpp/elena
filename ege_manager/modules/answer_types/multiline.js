...
AnswerTypes.multiline = {
  "solve": function(where, ans, active) {
    ...
    $("<textarea cols=\"70\" rows=\"10\"/>").appendTo(ans_place).addClass("form-control").val(ans.descr.value).on("input", function(){
      $(this).find("a").click();
    }.bind(ans_place));
    ...
    if (active)
      ...
      ans_place.find("textarea").attr("disabled", true);
  },
  "check": function(where, ans) {
    ...
    $("<span>&nbsp;&nbsp;&nbsp;</span>").appendTo(ans_place);
    $("<textarea cols=\"70\" rows=\"10\"/>").appendTo(ans_place).addClass("form-control").val(ans.descr.value).attr("disabled", true);
    $("<span>&nbsp;&nbsp;&nbsp;</span>").appendTo(ans_place);
